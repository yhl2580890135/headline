...
<div id="main">
    <div class="container">
        <div class="post detail">
            ...
            <div class="votebar">
            <#if (like gt 0)>
                <button class="click-like up pressed" data-id="${news.id}" title="赞同"><i class="vote-arrow"></i><span
                        class="count">${news.likeCount}</span></button>
            <#else>
                <button class="click-like up" data-id="${news.id}" title="赞同"><i class="vote-arrow"></i><span
                        class="count">${news.likeCount}</span></button>
            </#if>
            ...
            <div class="subject-name">来自 <a href="/user/${owner.id}">${owner.username}</a></div>
        </div>
        <!--
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading">
                        <small class="date"> ${commentvo.comment.createdDate}</small>
                    </h4>
